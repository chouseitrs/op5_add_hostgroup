...
for host in range(len(host2up)):
    ...
    if args.hostgroup not in hgs[0]['groups']:
        hgs[0]['groups'].append(args.hostgroup)
        print("Adding hostgroup "+args.hostgroup+" to "+str(hgs[0]['name']))
        payloadbeg = '''<root>
        ...
        print("Nothing to do. Hostgroup "+args.hostgroup+" already has member: "+str(hgs[0]['name']))
